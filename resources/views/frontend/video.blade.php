...
<head>
    ...
    <style>
        html {
            background-image: url("assets/background/27.png");
        }
...
<body>
    <div class="appcontainer">
        <div style="margin: 65% 0 0 17%">
            <a href="#" onclick="showVideoModal('PBKuVT6TOp4')">
                <img src="assets/icon/30.png" width="80%" />
            </a>
        </div>
        <div style="margin: 5% 0 0 17%">
            <a href="#" onclick="showVideoModal('CBwQRMjC00w')">
                <img src="assets/icon/31.png" width="80%" />
            </a>
        </div>
        <div style="margin: 5% 0 0 17%">
            <a href="#" onclick="showVideoModal('aAAeeteNmOk')">
                <img src="assets/icon/32.png" width="80%" />
            </a>
        </div>
        <div style="margin: 5% 0 0 17%">
            <a href="#" onclick="showVideoModal('gB7DDyk4enM')">
                <img src="assets/icon/33.png" width="80%" />
            </a>
        </div>
        <div style="margin: 28% 0 0 8%;">
            <a href="{{ route('faq6') }}">
